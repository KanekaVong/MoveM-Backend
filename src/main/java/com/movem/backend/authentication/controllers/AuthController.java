...
import com.movem.backend.authentication.dtos.requests.*;
...
import com.movem.backend.commons.Exception.EmailNotVerifiedException;
...
public class AuthController {
    ...
    public ResponseEntity<?> verifyOtp(@RequestBody OtpVerifyRequest request) {
        ...
        Optional<TrustedDevice> existingDevice = trustedDeviceRepository.findByUserIdAndDeviceIdAndRevokedAtIsNull(user.getId(), request.getDeviceId());
    ...
    public ResponseEntity<?> logout(@RequestBody Map<String, String> request) {
        ...
        trustedDeviceRepository
                .findByUserIdAndDeviceIdAndRevokedAtIsNull(currentUser.getId(), deviceId)
                .ifPresent(device -> {device.setRevokedAt(LocalDateTime.now());
